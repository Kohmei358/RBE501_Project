...
% leg 1
P_c1_1 = m1*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T01_1*[0 0 0.08 1]';
P_c2_1 = m2*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T02_1*[0.13 0.13 0.02 1]';
P_c3_1 = m3*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_1*[0.18 0.18 0 1]';
P_c4_1 = m4*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_1*[0.03 0.03 0 1]';

% leg 2
P_c1_2 = m1*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T01_2*[0 0 0.08 1]';
P_c2_2 = m2*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T02_2*[0.13 0.13 0.02 1]';
P_c3_2 = m3*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_2*[0.18 0.18 0 1]';
P_c4_2 = m4*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_2*[0.03 0.03 0 1]';

% leg 3
P_c1_3 = m1*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T01_3*[0 0 0.08 1]';
P_c2_3 = m2*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T02_3*[0.13 0.13 0.02 1]';
P_c3_3 = m3*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_3*[0.18 0.18 0 1]';
P_c4_3 = m4*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_3*[0.03 0.03 0 1]';

% leg 4
P_c1_4 = m1*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T01_4*[0 0 0.08 1]';
P_c2_4 = m2*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T02_4*[0.13 0.13 0.02 1]';
P_c3_4 = m3*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_4*[0.18 0.18 0 1]';
P_c4_4 = m4*[0 0 9.81 0]*[inv(R_earth_to_body) [0 0 0].'; [0 0 0 1]]*T03_4*[0.03 0.03 0 1]';
...
% a = diff(L,t11dot)
% 
% b = diff(a, t11)*t11dot + diff(a,t11dot)*t11_double_dot + ...
%     diff(a, t12)*t12dot + diff(a,t12dot)*t12_double_dot + ...
%     diff(a, t13)*t13dot + diff(a,t13dot)*t13_double_dot
% 
% tau11 = b - diff(L,t11);
% 
% tau11 = subs(tau11, [phi theta psi],[0 0 0])
% tau11 = simplify(expand(vpa(tau11)))
% tau11 = vpa(tau11,4)
% 
% 
% % Joint 2 leg1 
...
% tau12 = b - diff(L,t12);
% 
% tau12 = subs(tau12, [phi theta psi],[0 0 0])
% tau12 = simplify(expand(vpa(tau12)))
% tau12 = vpa(tau12,4)
% subs(tau12, [phi theta psi],[0 0 0])
% subs(tau12, [t11 t12 t13 t11dot t12dot t13dot t11_double_dot t12_double_dot t13_double_dot], [2 2 2 2 2 2 2 2 2])
% vpa(ans)
% 
% % Joint 3 leg 1 
% 
...
% tau13 = b - diff(L,t13);
% 
% tau13 = subs(tau13, [phi theta psi],[0 0 0])
% tau13 = simplify(expand(vpa(tau13)))
% tau13 = vpa(tau13,4)
% subs(tau13, [phi theta psi],[0 0 0])
% subs(tau13, [t11 t12 t13 t11dot t12dot t13dot t11_double_dot t12_double_dot t13_double_dot], [2 2 2 2 2 2 2 2 2])
% vpa(ans)
% 
% 
% 
